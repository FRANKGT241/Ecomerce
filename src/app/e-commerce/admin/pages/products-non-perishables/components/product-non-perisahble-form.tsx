...
export function ProductForm({ onSubmit, initialData }: ProductFormProps) {
  ...
  return (
    <form
      ...
      className="space-y-4 max-h-[80vh] overflow-y-auto" // Limitar la altura y permitir el scroll
    >
      <div>
      ...
      <div>
        ...
        <Input id="meta_description" name="meta_description" type="description" value={formData.meta_description} onChange={handleChange} />
      </div>
